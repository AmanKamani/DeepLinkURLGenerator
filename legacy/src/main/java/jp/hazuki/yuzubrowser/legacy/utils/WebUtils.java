...
public class WebUtils {
     ...
     * Return type : String(generated deep link string)
     * Description :
     *      This method accept the 2 parameters - website url, website title.
     *      It will generate the dynamic deep link for the given website url.
     *      And it will return the generated deep link url.
     *
     * Written By : Aman Kamani
     */
    private static String generateDeepLink(String url, String title){
        ...
        DynamicLink dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
            ...
            .setSocialMetaTagParameters(new DynamicLink.SocialMetaTagParameters.Builder()
                .setTitle("Yuzu Browser - "+title)
                .setImageUrl(Uri.parse("https://lh3.googleusercontent.com/mQy9NA8KCe43kHieyzdI5XRRDjkMf6RBPJHkF9dQaV8Q8vwjpU6HHbRbbKmilUuE1MsO"))
                .build())
            .buildDynamicLink();
    ...
    // This method will invoke generateDeepLink method and create the intent
    public static Intent createShareWebIntent(String url, String title) {

        url = generateDeepLink(url,title);
    ...
    // This method will be invoked when the user clicks on the Share Page option.
    public static void shareWeb(Context context, String url, String title) {
        if (url == null || url.trim().equals("yuzu:speeddial")) {
            Toast.makeText(context,"Please, Enter Url First.",Toast.LENGTH_LONG).show();
            return;
        }
